...
export const productData = [
  {
    id: 'DND001',
    name: 'Máy cắt điện hạ thế',
    description: 'Máy cắt điện hạ thế có khả năng bảo vệ hệ thống điện trong các tòa nhà hoặc khu công nghiệp.',
    descriptionRelation: 'Máy cắt điện được thiết kế để bảo vệ hệ thống điện hạ thế khỏi quá tải và ngắn mạch.',
    features: 'Bảo vệ ngắn mạch, bảo vệ quá tải, đóng cắt nhanh chóng.',
    specifications: 'Điện áp định mức: 400V; Dòng điện định mức: 630A; Tần số: 50Hz.',
    reviews: 'Sản phẩm đáng tin cậy, đã được sử dụng rộng rãi trong các hệ thống điện công nghiệp.',
    price: '10,000 VND',
    status: true,
  ...
  },
  {
    id: 'DND002',
    name: 'Máy biến áp',
    description: 'Máy biến áp dùng để tăng hoặc giảm điện áp trong các hệ thống truyền tải điện.',
    descriptionRelation: "Máy biến áp có chức năng chuyển đổi điện áp nhằm đảm bảo an toàn và hiệu quả cho việc truyền tải điện năng.",
    features: "Hiệu suất cao, độ tin cậy cao, bảo trì dễ dàng.",
    specifications: "Công suất định mức: 500kVA; Điện áp sơ cấp: 22kV; Điện áp thứ cấp: 0.4kV.",
    reviews: "Thiết bị hoạt động ổn định, hiệu suất truyền tải cao.",
    price: '70,000 VND',
    status: false,
